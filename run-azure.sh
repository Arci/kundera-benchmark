...
java -cp target/kundera-benchmarks-1.0-SNAPSHOT.jar:target/dependency/* com.yahoo.ycsb.Client -t -db it.polimi.ycsb.database.AzureTableClient -P src/main/resources/workloads/workloadinsert100K -P src/main/resources/azure.properties -s -threads 30 -t > ../transaction_lowlevelAPI_azure
