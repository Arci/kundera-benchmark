...
import it.polimi.ycsb.entities.HBaseUser;
...
/**
 * YCSB client that uses Kundera HBase extension to interact with HBase.
 *
...
public class KunderaHBaseClient extends DB {
    ...
    private static final String PU = "kundera_hbase_pu";
    ...
    public int read(String table, String key, Set<String> fields, HashMap<String, ByteIterator> result) {
        ...
        try {
            final Object o = em.find(HBaseUser.class, key);
            if (o == null) {
    ...
    public int insert(String table, String key, HashMap<String, ByteIterator> values) {
        ...
        try {
            HBaseUser user = new HBaseUser(key, nextString(), nextString(), nextString(), nextString());
            em.persist(user);
            if (timeToClearEntityManager()) {
                em.clear();
            }
