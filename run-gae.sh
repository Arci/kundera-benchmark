...
java -cp target/kundera-benchmarks-1.0-SNAPSHOT.jar:target/dependency/* com.yahoo.ycsb.Client -t -db it.polimi.ycsb.database.DatastoreClient -P src/main/resources/workloads/workloadinsert100K -P src/main/resources/datastore.properties -s -threads 30 -t > ../transaction_lowlevelAPI_datastore
